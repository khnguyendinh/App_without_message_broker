...
import com.example.sender.store.DatabaseMapStore;
...
public class HazelcastConfig {
    ...
    public HazelcastInstance hazelcastInstance() {
        ...
        config.setInstanceName("sender-hz-instance");
        ...
        // Create MapStore manually (not Spring-managed) to avoid circular dependency
